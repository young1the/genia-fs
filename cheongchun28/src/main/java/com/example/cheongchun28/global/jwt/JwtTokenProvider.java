...
public class JwtTokenProvider {
    ...
    public String createToken(Authentication authentication) {
        Claims claims = Jwts.claims().setSubject(authentication.getName());   //Claims: JWT payload에 저장되는 정보단위, 보통 여기서 user를 식별하는 값을 넣는다.
//        claims.put("roles", roles); //정보는 key / value 쌍으로 저장된다.
    ...
    // Request의 Header에서 token 값을 가져옵니다. "Authorization" : "Token값" 의 형태로 가져오게 됨.
