...
const NewPasswordInput = forwardRef<HTMLInputElement, PasswordInputProps>(
    ...
    return (
      <div>
        ...
        <div className='flex space-x-3 mx-2'>
          ...
          <p
            className={`font-semibold text-xs ${hasSpecial ? valid : invalid}`}
          >
            ✓ 특수문자
          </p>
          <p
            className={`font-semibold text-xs ${moreThanTen ? valid : invalid}`}
          >
            ✓ 10자 이상
          </p>
        </div>
