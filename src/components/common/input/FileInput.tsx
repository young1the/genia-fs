...
const FileInput = () => {
  ...
  return (
    <div className='flex items-center justify-center relative'>
      ...
      <button ref={buttonRef} onClick={toggleState} className='absolute -right-5 bottom-0'>
        ...
        {showDropdown ? (
          ...
          >
            ...
            >
              ...
              <li className='block px-4 py-2 text-red-500 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white'>
                <p>프로필 삭제하기</p>
              </li>
            </ul>
          </div>
